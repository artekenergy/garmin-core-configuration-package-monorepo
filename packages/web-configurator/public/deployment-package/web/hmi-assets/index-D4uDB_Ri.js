...
function Gauge(props) {
  ...
  function scaleNumeric(raw) {
    var _a;
    const ch = ((_a = component.bindings) == null ? void 0 : _a.value) && component.bindings.value.channel;
