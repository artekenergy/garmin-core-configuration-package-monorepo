...
export function generateTabComponents(
  ...
  const relevantOutputs = getRelevantOutputsForSection(
 ...
 */
export function generateDefaultComponents(_tabPreset: string, _sectionId: string): Component[] {
