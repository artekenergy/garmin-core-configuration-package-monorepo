 ...
 */
export function validateUniqueComponentIds(schema) {
    const errors = [];
 ...
 */
export function validateIconReferences(schema) {
    const errors = [];
 ...
 */
export function validateUniqueIconIds(schema) {
    const errors = [];
    const seenIds = new Set();
 ...
 */
export function validateUniqueTabIds(schema) {
    const errors = [];
    const seenIds = new Set();
 ...
 */
export function validateUniqueSectionIds(schema) {
    const errors = [];
    schema.tabs.forEach((tab, tabIndex) => {
        const seenIds = new Set();
        tab.sections.forEach((section, sectionIndex) => {
 ...
 */
export function runCustomValidations(schema) {
    const errors = [];
